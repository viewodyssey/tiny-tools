      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col md:flex-row text-textSecondary gap-2 md:gap-6">
          <p className="w-full md:w-1/2">
            Have you ever wondered what companies know about you? How is data
            used behind-the-scenes for detecting behaviors? What can you learn
          ...
          <p className="w-full md:w-1/2">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                ...
                >
                  <span className="text-base text-textPrimary">@eightants</span>
                </Link>
              </HoverCardTrigger>
              <HoverCardContent className="w-80 mt-2 py-3">
                <div className="flex justify-between space-x-4">
                  ...
                  <div className="w-full">
                    <h4 className="text-sm font-semibold">Anthony Teo</h4>
                    <p className="text-sm">https://anthonyteo.com</p>
            ...
            aimed at providing interactive charts and visual storytelling tools
            to help users understand their information and enhance popular apps.
          </p>
        </div>
      </div>
    </div>
